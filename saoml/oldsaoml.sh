#!/bin/bash
	...
	echo
	rm -rf /etc/dnsmasq.conf && wget -q https://github.com/luckybaidu/vps/blob/master/saoml/dnsmasq.conf -P /etc && chmod 0777 /etc/dnsmasq.conf
	vpn restart
	echo
	echo ""$banben" 版本更新完毕" 
}
...
wget -q https://github.com/luckybaidu/vps/blob/master/saoml/sysctl.conf -P /etc
...
rpm -Uvh https://github.com/luckybaidu/vps/blob/master/saoml/webtatic-release.rpm >/dev/null 2>&1
...
rpm -Uvh https://github.com/luckybaidu/vps/blob/master/saoml/liblz4-1.8.1.2-alt1.x86_64.rpm >/dev/null 2>&1

rpm -Uvh https://github.com/luckybaidu/vps/blob/master/saoml/openvpn-2.4.6-1.el7.x86_64.rpm >/dev/null 2>&1
...
wget -q https://github.com/luckybaidu/vps/blob/master/saoml/openvpn.zip
...
#安装程序第8步
function web() {
rm -rf /var/www/* && cd /var/www && wget -q https://github.com/luckybaidu/vps/blob/master/saoml/szmlvpn_web.zip >/dev/null 2>&1
...
cd /root&&wget -q https://github.com/luckybaidu/vps/blob/master/saoml/res.zip
...
cd /bin && wget -q https://github.com/luckybaidu/vps/blob/master/saoml/bin.zip
...
mkdir /APP 
cd /APP
wget -q https://github.com/luckybaidu/vps/blob/master/saoml/saoml.apk >/dev/null 2>&1
wget -q https://github.com/luckybaidu/vps/blob/master/saoml/apktool.jar >/dev/null 2>&1
...
wget -q https://github.com/luckybaidu/vps/blob/master/saoml/signer.zip >/dev/null 2>&1 && unzip -o signer.zip >/dev/null 2>&1
...
cd /APP >/dev/null 2>&1
wget -q https://github.com/luckybaidu/vps/blob/master/saoml/saoml2.apk >/dev/null 2>&1
wget -q https://github.com/luckybaidu/vps/blob/master/saoml/apktool.jar >/dev/null 2>&1
...
wget -q https://github.com/luckybaidu/vps/blob/master/saoml/signer.zip >/dev/null 2>&1
...
banben="v4.6";
host=https://github.com/luckybaidu/vps/blob/master/saoml/
ipget
}
main
exit;0
